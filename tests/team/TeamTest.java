...
class TeamTest {
    ...
    void setUp() {
        ...
        team6 = new Team("Hold 6");
        team6.addMember(player1);
        team6.addMember(player2);
    ...
    void getTeamMembers() {
        ...
        a.add(player1);
        a.add(player2);
        assertEquals(a,team6.getTeamMembers());     // this fails because not set teammembers in setup
    }
    ...
    @Test
    void addMember() {      //tested from setup
    }
